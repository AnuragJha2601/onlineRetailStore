          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="text-center sm:text-left">
              <p className="text-sm font-semibold text-rose-700">
                ✨ Like what you see? Order directly via WhatsApp or Instagram!
              </p>
              <p className="text-xs text-amber-700 mt-0.5">
                💛 Bulk orders welcome — better prices for bigger quantities. DM us!
              </p>
            </div>
            <div className="flex items-center gap-3 flex-shrink-0">
              <a
                ...
                className="flex items-center gap-1.5 bg-green-500 hover:bg-green-600 text-white text-xs font-semibold px-3 py-1.5 rounded-full transition-colors shadow-sm"
              >
              ...
              <a
                href="https://www.instagram.com/dhanaktrinket?igsh=dGRvb3R5YmpqbzJ5&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 hover:opacity-90 text-white text-xs font-semibold px-3 py-1.5 rounded-full transition-opacity shadow-sm"
              >
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
