...
namespace DhanakTrinket.Infrastructure.Migrations
{
    ...
    [Migration("20260726195748_AddInvoices")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DhanakTrinket.Core.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DhanakTrinket.Core.Entities.InvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DhanakTrinket.Core.Entities.InvoiceItem", b =>
                {
                    b.HasOne("DhanakTrinket.Core.Entities.Invoice", "Invoice")
                        .WithMany("Items")
